...
@section('main-content')
    <div class="container mt-10 max-w-3xl mx-auto neo-card p-8 rounded-2xl bg-gray-50">
        <h2 class="text-2xl font-bold mb-6 text-center">✏️ Edit Conference Review Schedule</h2>

        <form method="POST" action="{{ route('admin.schedule.conferenceupdate', $schedules->id) }}"
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    <label for="conference_submission_id" class="block text-gray-700 font-semibold mb-2 ">
                        Paper</label><br>
                    <input type="text" name="current_paper" style="width:100%" readonly
                        value="{{ $schedules->conferenceSubmission->title ??
                            \Illuminate\Support\Str::of($schedules->conferenceSubmission->paper_path)->afterLast('/') }}"
