...
@section('main-content')
    <div
        ...
        <h2 class="text-4xl font-extrabold text-center text-gray-800 mb-10 tracking-tight">
            📅Conference Paper Review Schedule List
        </h2>
                ...
                @forelse ($schedules as $index => $schedule)
                    <tr class="border-t hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-2">
                            ...
                            Paper{{ $schedule->conferenceSubmission->id }}
                        </td>

                        <td class="px-4 py-2">
                            {{ $schedule->conferenceSubmission->user->name ?? 'User ' . $schedule->conferenceSubmission->user_id }}
                        </td>
