...
@section('main-content')
    <div class="container mt-10 max-w-3xl mx-auto neo-card p-8 rounded-2xl bg-gray-50">
        <h2 class="text-2xl font-bold mb-6 text-center">✏️ Edit Journal Submission</h2>

        <form method="POST" action="{{ route('admin.papers.journalupdate', $submission->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
