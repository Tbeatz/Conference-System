...
@if ($section === 'notification')
    <div
        class="author-notifications p-6 bg-gradient-to-r from-green-100 to-blue-500 text-black rounded shadow w-full max-w-5xl mx-auto">
                ...
                @foreach ($notifications as $notification)
                    <li class="border p-3 rounded bg-blue-50 flex justify-between items-center">
                        <div>
                                ...
                                <div x-data="{
                                    ...
                                    <div x-show="show"
                                        ...
                                        <div @click.away="show = false"
                                            class="bg-gradient-to-r from-green-200 to-blue-200 text-black mt-10 rounded-lg shadow-lg overflow-y-auto max-h-[70vh] max-w-2xl w-full p-6">
                                                ...
                                                <form method="POST" :action="`/conference/${submissionId}`"
                                                    ...
                                                    <div>
                                                        <label for="professor_rule_file"
                                                            class="block font-medium text-gray-700">University Recommendation
                                                            (PDF,
                                                            DOC, DOCX)</label>
                            ...
                            @elseif (isset($notification->data['evaluation']) && in_array($notification->data['evaluation'], ['acceptable']))
                                <div x-data="{
                                    show: false,
                                    submissionId: null,
                                    category: '',
                                    ...
                                    <div x-show="show"
                                        ...
                                        <div @click.away="show = false"
                                            class="bg-gradient-to-r from-green-200 to-blue-200 text-black mt-10 rounded-lg shadow-lg overflow-y-auto max-h-[70vh] max-w-2xl w-full p-6">
                                            <h2 class="text-xl font-semibold mb-4 text-gray-700">Upload For Your Paper
                                            </h2>
                                            ...
                                            <template x-if="category === 'conference'">
                                                <form method="POST" :action="`/conference/${submissionId}`"
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" name="kpay_image" id="kpay_image"
                                                            accept=".jpg,.jpeg,.png"
                                                            class="w-full border rounded px-3 py-2">
                                                    </div>
                                                    {{-- <div>
                        ...
                        <form method="POST" action="{{ route('notifications.markReadRead', $notification->id) }}">
                            @csrf
                            <div class="bg-white rounded-lg shadow-lg p-1">
                                <button type="submit"
                                    class="text-sm text-black hover:text-green-900 whitespace-nowrap px-2 py-1 rounded-md">
                                    Mark read
                                </button>
                            </div>
        ...
        @if ($readNotifications->count() > 0)
            <ul class="space-y-3">
                @foreach ($readNotifications as $notification)
                    <li class="border p-3 rounded bg-blue-50 flex justify-between items-center">
                        <div>
                            <p class="text-gray-800" style="text-align: justify;">
                            ...
                            @if (isset($notification->data['evaluation']) &&
                                ...
                                <div x-data="{
                                    ...
                                    <div x-show="show"
                                        ...
                                        <div @click.away="show = false"
                                            class="bg-gradient-to-r from-green-200 to-blue-200 text-black mt-10 rounded-lg shadow-lg overflow-y-auto max-h-[70vh] max-w-2xl w-full p-6">
                                            <h2 class="text-xl font-semibold mb-4 text-gray-700">Edit Your Paper
                                            </h2>
                                            ...
                                            <form method="POST" :action="`/conference/${submissionId}`"
                                                ...
                                                <div>
                                                    <label for="paper"
                                                        class="block font-medium text-gray-700">Paper (PDF, DOC,
                                                        DOCX)</label>
                                                    <input type="file" name="paper" id="paper"
                                                        accept=".pdf,.doc,.docx"
                                                        class="w-full border rounded px-3 py-2 bg-white">
